...
def save_to_db(owner: str, token_out_mint: str, amount_out: float, token_in_mint: str, amount_in: float, price_per_token: float):
...
def decode_swap(signature: str):
    ...
    token_changes = decode_token_changes(tx)
    sol_changes = decode_sol_changes(tx)
    ...
    for owner in unique_owners_in_tx:
        if owner in whales:
            ...
            if token_in and token_out:
                ...
                save_to_db(str(owner), str(token_out_mint), token_out_change, str(token_in_mint), token_in_change, price_per_token)